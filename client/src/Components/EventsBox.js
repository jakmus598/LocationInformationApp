...
class EventsBox extends TextBox
{
    ...
    render()
    {
        ...
        return (<TextBox className="box" style={{width: '18rem'}} title="Upcoming Events"> 
            {   
        ...
        getEventsArray()
        {
                ...
                for(var i in this.state['events'])
                {
                    ...
                    textButtons.push(<TextButton className="event-button" name={currentValue['name']} url={currentValue['url']}></TextButton>)
                }
                return textButtons
